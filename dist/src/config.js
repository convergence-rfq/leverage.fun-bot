...
class Config {
    ...
    TESTNET_WETH_POOL = new PublicKey('J6QSQw6bpF7PAADTJcoNxNFy8akWjrCHc4bxt2tmW3C5');
    ...
    SOLANA_DEVNET_ORACLE = new PublicKey('HjsyECjkjTUX5tz6eKXcdJBGQuf1zYToPnxc4hY8w12f');
    VAULTS_PROGRAM_ID = new PublicKey('doVLtcguouVHW5c6odaNrbcHAUEd2fkMGxq28efDptj');
    AUCTION_PROGRAM_ID = new PublicKey('BTxfkFZ7bGfse162Tz3hHpd9NxJJxYrFMj63iFmVDs7i');
    jsonToBs58(json) {
